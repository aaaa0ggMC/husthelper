...
- [宿舍电费查询 (docs/electricity.md)](./docs/electricity.md)
...
> `await client.loginByQrCode()`——无需密码、验证码与 OCR，扫码授权后即可获得 `CASTGC`（详见 [docs/auth.md](./docs/auth.md) 与 [`examples/login_qrcode.ts`](./examples/login_qrcode.ts)）。
>
