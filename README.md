...
| `hustreport` | 报告文档处理（实验性半成品，BUG较多）：docx 样式分段与稳定 ref、AI 抽模板、Markdown 保格式填空渲染。**辅助排版，产出后需人工复核；含目录时须在 Word/WPS 手动「更新目录 / 更新域」** | [hustreport/README.md](./hustreport/README.md) |
